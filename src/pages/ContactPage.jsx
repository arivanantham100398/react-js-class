...
function ContactPage() {
    return (
        <>
            <TwoColumnLayout
                imageUrl={"https://images.unsplash.com/photo-1499159058454-75067059248a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80"}
                title={"Contact Page"}
